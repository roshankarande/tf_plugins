...
func resourceRepository() *schema.Resource {
	...
	MergeSchema(s, SchemaCommandSpec())
...
func resourceRepositoryUpdate(d *schema.ResourceData, m interface{}) error {
	...
	commandError := ExecuteCommand(d,"command_before_update", marshalResourceRepositoryProperties)
	if commandError != nil {
		return commandError
	}
...
func resourceRepositoryCreate(d *schema.ResourceData, m interface{}) error {
	...
	// _custom_
	commandError := ExecuteCommand(d,"command_before_create", marshalResourceRepositoryProperties)
	if commandError != nil {
		return commandError
	}

	//commandError = ExecuteCommand(d,"command_after_create", marshalResourceRepositoryProperties)
	//if commandError != nil {
	//	return commandError
	//}
...
func resourceRepositoryDelete(d *schema.ResourceData, m interface{}) error {
	...
	commandError := ExecuteCommand(d,"command_before_delete", marshalResourceRepositoryProperties)
	if commandError != nil {
		return commandError
	}
...
func marshalResourceRepositoryProperties(d *schema.ResourceData) (string, error) {

	properties := make(map[string]interface{})
	properties["name"] = d.Get("name").(string)
	properties["project"] = d.Get("project").(string)
	properties["description"] = d.Get("description").(string)
